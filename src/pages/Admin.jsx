...
const Admin = () => {
  ...
  return (
    <div
      className="flex"
      style={{ height: "100%", position: "absolute", zIndex: "9999" }}
    >
      {/* Sidebar */}
      <div className="bg-custom-black text-white w-64 flex flex-col">
            ...
            <div
              ...
              className={`flex items-center justify-start py-2 px-6 uppercase cursor-pointer transition-colors ${
                selectedNavItem === item.name
                  ...
                  : "hover:bg-custom-red hover:text-gray-200"
              }`}
            >
        ...
        {/* Sign Out Button */}
        <div
          className="mt-auto py-4 px-6 cursor-pointer"
          onClick={handleSignOut}
          style={{ fontFamily: "formula1" }}
        >
          <Link
            to="/"
            className="uppercase text-md font-bold focus:outline-none flex items-center bg-custom-red text-white py-2 px-4 rounded"
          >
            Sign Out
          </Link>
        </div>
      ...
      <div className="flex-1 bg-white">
        <div className="p-6">
          <h2 className="text-custom-black text-2xl font-bold capitalize">
            {selectedNavItem}
          </h2>
